...
ANCIENT_DEBRIS = CustomItem(internal_name="minecraft:ancient_debris", base_item="ancient_debris", components=Components(break_sound='minecraft:entity.item.break', damage_resistant_to='#minecraft:is_fire'))
APPLE = CustomItem(internal_name="minecraft:apple", base_item="apple", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=4, saturation=2)))
BAKED_POTATO = CustomItem(internal_name="minecraft:baked_potato", base_item="baked_potato", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=5, saturation=6)))
BEEF = CustomItem(internal_name="minecraft:beef", base_item="beef", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=3, saturation=1)))
BEETROOT = CustomItem(internal_name="minecraft:beetroot", base_item="beetroot", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=1, saturation=1)))
BEETROOT_SOUP = CustomItem(internal_name="minecraft:beetroot_soup", base_item="beetroot_soup", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=7), use_remainder=UseRemainder(item='minecraft:bowl')), max_stack_size=1)
BLACK_CARPET = CustomItem(internal_name="minecraft:black_carpet", base_item="black_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
BLUE_CARPET = CustomItem(internal_name="minecraft:blue_carpet", base_item="blue_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
BOW = CustomItem(internal_name="minecraft:bow", base_item="bow", components=Components(durability=384, enchantable_at_level=1, break_sound='minecraft:entity.item.break'), max_stack_size=1)
BREAD = CustomItem(internal_name="minecraft:bread", base_item="bread", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=5, saturation=6)))
BROWN_CARPET = CustomItem(internal_name="minecraft:brown_carpet", base_item="brown_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
BRUSH = CustomItem(internal_name="minecraft:brush", base_item="brush", components=Components(durability=64, break_sound='minecraft:entity.item.break'), max_stack_size=1)
CARROT = CustomItem(internal_name="minecraft:carrot", base_item="carrot", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=3, saturation=3)))
CARROT_ON_A_STICK = CustomItem(internal_name="minecraft:carrot_on_a_stick", base_item="carrot_on_a_stick", components=Components(durability=25, break_sound='minecraft:entity.item.break'), max_stack_size=1)
CARVED_PUMPKIN = CustomItem(internal_name="minecraft:carved_pumpkin", base_item="carved_pumpkin", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False, camera_overlay='minecraft:misc/pumpkinblur')))
CHAINMAIL_BOOTS = CustomItem(internal_name="minecraft:chainmail_boots", base_item="chainmail_boots", components=Components(durability=195, enchantable_at_level=12, repaired_by='#minecraft:repairs_chain_armor', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='feet'), AttributeModifier(attribute_type='armor_toughness', slot='feet', amount=0.0)], equippable=Equippable(slot='feet', equip_sound='minecraft:item.armor.equip_chain')), max_stack_size=1, rarity="uncommon")
...
CHICKEN = CustomItem(internal_name="minecraft:chicken", base_item="chicken", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='hunger', duration_in_ticks=600)]), food=Food(nutrition=2, saturation=1)))
CHORUS_FRUIT = CustomItem(internal_name="minecraft:chorus_fruit", base_item="chorus_fruit", components=Components(break_sound='minecraft:entity.item.break', cooldown=Cooldown(seconds=1.0), consumable=Consumable(), food=Food(nutrition=4, saturation=2, can_always_eat=True)))
COD = CustomItem(internal_name="minecraft:cod", base_item="cod", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2)))
COOKED_BEEF = CustomItem(internal_name="minecraft:cooked_beef", base_item="cooked_beef", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=8, saturation=12)))
COOKED_CHICKEN = CustomItem(internal_name="minecraft:cooked_chicken", base_item="cooked_chicken", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=7)))
COOKED_COD = CustomItem(internal_name="minecraft:cooked_cod", base_item="cooked_cod", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=5, saturation=6)))
COOKED_MUTTON = CustomItem(internal_name="minecraft:cooked_mutton", base_item="cooked_mutton", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=9)))
COOKED_PORKCHOP = CustomItem(internal_name="minecraft:cooked_porkchop", base_item="cooked_porkchop", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=8, saturation=12)))
COOKED_RABBIT = CustomItem(internal_name="minecraft:cooked_rabbit", base_item="cooked_rabbit", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=5, saturation=6)))
COOKED_SALMON = CustomItem(internal_name="minecraft:cooked_salmon", base_item="cooked_salmon", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=9)))
COOKIE = CustomItem(internal_name="minecraft:cookie", base_item="cookie", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2)))
CREEPER_HEAD = CustomItem(internal_name="minecraft:creeper_head", base_item="creeper_head", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="uncommon")
CROSSBOW = CustomItem(internal_name="minecraft:crossbow", base_item="crossbow", components=Components(durability=465, enchantable_at_level=1, break_sound='minecraft:entity.item.break'), max_stack_size=1)
CYAN_CARPET = CustomItem(internal_name="minecraft:cyan_carpet", base_item="cyan_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
DIAMOND_AXE = CustomItem(internal_name="minecraft:diamond_axe", base_item="diamond_axe", components=Components(durability=1561, enchantable_at_level=10, repaired_by='#minecraft:diamond_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=8.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_diamond_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/axe', speed=8.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=5.0)), max_stack_size=1)
DIAMOND_BOOTS = CustomItem(internal_name="minecraft:diamond_boots", base_item="diamond_boots", components=Components(durability=429, enchantable_at_level=10, repaired_by='#minecraft:repairs_diamond_armor', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='feet', amount=3.0), AttributeModifier(attribute_type='armor_toughness', slot='feet', amount=2.0)], equippable=Equippable(slot='feet', equip_sound='minecraft:item.armor.equip_diamond')), max_stack_size=1)
...
DIAMOND_HOE = CustomItem(internal_name="minecraft:diamond_hoe", base_item="diamond_hoe", components=Components(durability=1561, enchantable_at_level=10, repaired_by='#minecraft:diamond_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=0.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=0.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_diamond_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/hoe', speed=8.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
DIAMOND_HORSE_ARMOR = CustomItem(internal_name="minecraft:diamond_horse_armor", base_item="diamond_horse_armor", components=Components(break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='body', amount=11.0), AttributeModifier(attribute_type='armor_toughness', slot='body', amount=2.0)], equippable=Equippable(slot='body', equip_sound='minecraft:entity.horse.armor', damage_on_hurt=False, entities_which_can_wear='#minecraft:can_wear_horse_armor')), max_stack_size=1)
...
DRAGON_HEAD = CustomItem(internal_name="minecraft:dragon_head", base_item="dragon_head", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="epic")
DRIED_KELP = CustomItem(internal_name="minecraft:dried_kelp", base_item="dried_kelp", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(consume_seconds=0.8), food=Food(nutrition=1)))
ELYTRA = CustomItem(internal_name="minecraft:elytra", base_item="elytra", components=Components(durability=432, glider=True, repaired_by='minecraft:phantom_membrane', break_sound='minecraft:entity.item.break', equippable=Equippable(slot='chest', equip_sound='minecraft:item.armor.equip_elytra', damage_on_hurt=False)), max_stack_size=1, rarity="epic")
ENCHANTED_GOLDEN_APPLE = CustomItem(internal_name="minecraft:enchanted_golden_apple", base_item="enchanted_golden_apple", components=Components(enchantment_glint_override=True, break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='regeneration', amplifier=1, duration_in_ticks=400), PotionEffect(effect_name='resistance', duration_in_ticks=6000), PotionEffect(effect_name='fire_resistance', duration_in_ticks=6000), PotionEffect(effect_name='absorption', amplifier=3, duration_in_ticks=2400)]), food=Food(nutrition=4, saturation=9, can_always_eat=True)), rarity="rare")
ENDER_PEARL = CustomItem(internal_name="minecraft:ender_pearl", base_item="ender_pearl", components=Components(break_sound='minecraft:entity.item.break', cooldown=Cooldown(seconds=1.0)), max_stack_size=16)
FISHING_ROD = CustomItem(internal_name="minecraft:fishing_rod", base_item="fishing_rod", components=Components(durability=64, enchantable_at_level=1, break_sound='minecraft:entity.item.break'), max_stack_size=1)
FLINT_AND_STEEL = CustomItem(internal_name="minecraft:flint_and_steel", base_item="flint_and_steel", components=Components(durability=64, break_sound='minecraft:entity.item.break'), max_stack_size=1)
GLOW_BERRIES = CustomItem(internal_name="minecraft:glow_berries", base_item="glow_berries", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2)))
GOLDEN_APPLE = CustomItem(internal_name="minecraft:golden_apple", base_item="golden_apple", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='regeneration', amplifier=1, duration_in_ticks=100), PotionEffect(effect_name='absorption', duration_in_ticks=2400)]), food=Food(nutrition=4, saturation=9, can_always_eat=True)))
GOLDEN_AXE = CustomItem(internal_name="minecraft:golden_axe", base_item="golden_axe", components=Components(durability=32, enchantable_at_level=22, repaired_by='#minecraft:gold_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=6.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_gold_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/axe', speed=12.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=5.0)), max_stack_size=1)
GOLDEN_BOOTS = CustomItem(internal_name="minecraft:golden_boots", base_item="golden_boots", components=Components(durability=91, enchantable_at_level=25, repaired_by='#minecraft:repairs_gold_armor', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='feet'), AttributeModifier(attribute_type='armor_toughness', slot='feet', amount=0.0)], equippable=Equippable(slot='feet', equip_sound='minecraft:item.armor.equip_gold')), max_stack_size=1)
GOLDEN_CARROT = CustomItem(internal_name="minecraft:golden_carrot", base_item="golden_carrot", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=14)))
...
GOLDEN_HOE = CustomItem(internal_name="minecraft:golden_hoe", base_item="golden_hoe", components=Components(durability=32, enchantable_at_level=22, repaired_by='#minecraft:gold_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=0.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_gold_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/hoe', speed=12.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
GOLDEN_HORSE_ARMOR = CustomItem(internal_name="minecraft:golden_horse_armor", base_item="golden_horse_armor", components=Components(break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='body', amount=7.0), AttributeModifier(attribute_type='armor_toughness', slot='body', amount=0.0)], equippable=Equippable(slot='body', equip_sound='minecraft:entity.horse.armor', damage_on_hurt=False, entities_which_can_wear='#minecraft:can_wear_horse_armor')), max_stack_size=1)
...
GRAY_CARPET = CustomItem(internal_name="minecraft:gray_carpet", base_item="gray_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
GREEN_CARPET = CustomItem(internal_name="minecraft:green_carpet", base_item="green_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
HONEY_BOTTLE = CustomItem(internal_name="minecraft:honey_bottle", base_item="honey_bottle", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(consume_seconds=2.0, animation='drink', consuming_sound='minecraft:item.honey_bottle.drink', has_consume_particles=False, on_consume_remove_effects=['minecraft:poison']), food=Food(nutrition=6, saturation=1, can_always_eat=True), use_remainder=UseRemainder(item='minecraft:glass_bottle')), max_stack_size=16)
IRON_AXE = CustomItem(internal_name="minecraft:iron_axe", base_item="iron_axe", components=Components(durability=250, enchantable_at_level=14, repaired_by='#minecraft:iron_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=8.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.1)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_iron_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/axe', speed=6.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=5.0)), max_stack_size=1)
IRON_BOOTS = CustomItem(internal_name="minecraft:iron_boots", base_item="iron_boots", components=Components(durability=195, enchantable_at_level=9, repaired_by='#minecraft:repairs_iron_armor', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='feet', amount=2.0), AttributeModifier(attribute_type='armor_toughness', slot='feet', amount=0.0)], equippable=Equippable(slot='feet', equip_sound='minecraft:item.armor.equip_iron')), max_stack_size=1)
...
LIGHT_BLUE_CARPET = CustomItem(internal_name="minecraft:light_blue_carpet", base_item="light_blue_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
LIGHT_GRAY_CARPET = CustomItem(internal_name="minecraft:light_gray_carpet", base_item="light_gray_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
LIME_CARPET = CustomItem(internal_name="minecraft:lime_carpet", base_item="lime_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
MACE = CustomItem(internal_name="minecraft:mace", base_item="mace", components=Components(durability=500, enchantable_at_level=15, repaired_by='minecraft:breeze_rod', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=5.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.4)], tool=Tool(damage_per_block=2)), max_stack_size=1, rarity="epic")
MAGENTA_CARPET = CustomItem(internal_name="minecraft:magenta_carpet", base_item="magenta_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
MELON_SLICE = CustomItem(internal_name="minecraft:melon_slice", base_item="melon_slice", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2, saturation=1)))
MILK_BUCKET = CustomItem(internal_name="minecraft:milk_bucket", base_item="milk_bucket", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(animation='drink', consuming_sound='minecraft:entity.generic.drink', has_consume_particles=False, on_consume_remove_effects='all'), use_remainder=UseRemainder(item='minecraft:bucket')), max_stack_size=1)
MUSHROOM_STEW = CustomItem(internal_name="minecraft:mushroom_stew", base_item="mushroom_stew", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=7), use_remainder=UseRemainder(item='minecraft:bowl')), max_stack_size=1)
MUSIC_DISC_11 = CustomItem(internal_name="minecraft:music_disc_11", base_item="music_disc_11", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:11')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_13 = CustomItem(internal_name="minecraft:music_disc_13", base_item="music_disc_13", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:13')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_5 = CustomItem(internal_name="minecraft:music_disc_5", base_item="music_disc_5", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:5')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_BLOCKS = CustomItem(internal_name="minecraft:music_disc_blocks", base_item="music_disc_blocks", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:blocks')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_CAT = CustomItem(internal_name="minecraft:music_disc_cat", base_item="music_disc_cat", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:cat')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_CHIRP = CustomItem(internal_name="minecraft:music_disc_chirp", base_item="music_disc_chirp", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:chirp')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_CREATOR = CustomItem(internal_name="minecraft:music_disc_creator", base_item="music_disc_creator", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:creator')), max_stack_size=1, rarity="rare")
MUSIC_DISC_CREATOR_MUSIC_BOX = CustomItem(internal_name="minecraft:music_disc_creator_music_box", base_item="music_disc_creator_music_box", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:creator_music_box')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_FAR = CustomItem(internal_name="minecraft:music_disc_far", base_item="music_disc_far", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:far')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_MALL = CustomItem(internal_name="minecraft:music_disc_mall", base_item="music_disc_mall", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:mall')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_MELLOHI = CustomItem(internal_name="minecraft:music_disc_mellohi", base_item="music_disc_mellohi", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:mellohi')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_OTHERSIDE = CustomItem(internal_name="minecraft:music_disc_otherside", base_item="music_disc_otherside", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:otherside')), max_stack_size=1, rarity="rare")
MUSIC_DISC_PIGSTEP = CustomItem(internal_name="minecraft:music_disc_pigstep", base_item="music_disc_pigstep", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:pigstep')), max_stack_size=1, rarity="rare")
MUSIC_DISC_PRECIPICE = CustomItem(internal_name="minecraft:music_disc_precipice", base_item="music_disc_precipice", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:precipice')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_RELIC = CustomItem(internal_name="minecraft:music_disc_relic", base_item="music_disc_relic", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:relic')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_STAL = CustomItem(internal_name="minecraft:music_disc_stal", base_item="music_disc_stal", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:stal')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_STRAD = CustomItem(internal_name="minecraft:music_disc_strad", base_item="music_disc_strad", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:strad')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_WAIT = CustomItem(internal_name="minecraft:music_disc_wait", base_item="music_disc_wait", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:wait')), max_stack_size=1, rarity="uncommon")
MUSIC_DISC_WARD = CustomItem(internal_name="minecraft:music_disc_ward", base_item="music_disc_ward", components=Components(break_sound='minecraft:entity.item.break', jukebox_playable=JukeboxPlayable(song='minecraft:ward')), max_stack_size=1, rarity="uncommon")
MUTTON = CustomItem(internal_name="minecraft:mutton", base_item="mutton", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2, saturation=1)))
NETHER_STAR = CustomItem(internal_name="minecraft:nether_star", base_item="nether_star", components=Components(enchantment_glint_override=True, break_sound='minecraft:entity.item.break', damage_resistant_to='#minecraft:is_explosion'), rarity="rare")
NETHERITE_AXE = CustomItem(internal_name="minecraft:netherite_axe", base_item="netherite_axe", components=Components(durability=2031, enchantable_at_level=15, repaired_by='#minecraft:netherite_tool_materials', break_sound='minecraft:entity.item.break', damage_resistant_to='#minecraft:is_fire', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=9.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_netherite_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/axe', speed=9.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=5.0)), max_stack_size=1)
NETHERITE_BLOCK = CustomItem(internal_name="minecraft:netherite_block", base_item="netherite_block", components=Components(break_sound='minecraft:entity.item.break', damage_resistant_to='#minecraft:is_fire'))
NETHERITE_BOOTS = CustomItem(internal_name="minecraft:netherite_boots", base_item="netherite_boots", components=Components(durability=481, enchantable_at_level=15, repaired_by='#minecraft:repairs_netherite_armor', break_sound='minecraft:entity.item.break', damage_resistant_to='#minecraft:is_fire', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='feet', amount=3.0), AttributeModifier(attribute_type='armor_toughness', slot='feet', amount=3.0), AttributeModifier(attribute_type='knockback_resistance', slot='feet', amount=0.1)], equippable=Equippable(slot='feet', equip_sound='minecraft:item.armor.equip_netherite')), max_stack_size=1)
...
OMINOUS_BOTTLE = CustomItem(internal_name="minecraft:ominous_bottle", base_item="ominous_bottle", components=Components(break_sound='minecraft:entity.item.break', ominous_bottle_amplifier=0, consumable=Consumable(animation='drink', consuming_sound='minecraft:entity.generic.drink', has_consume_particles=False)), rarity="uncommon")
ORANGE_CARPET = CustomItem(internal_name="minecraft:orange_carpet", base_item="orange_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
PIGLIN_HEAD = CustomItem(internal_name="minecraft:piglin_head", base_item="piglin_head", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="uncommon")
PINK_CARPET = CustomItem(internal_name="minecraft:pink_carpet", base_item="pink_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
PLAYER_HEAD = CustomItem(internal_name="minecraft:player_head", base_item="player_head", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="uncommon")
POISONOUS_POTATO = CustomItem(internal_name="minecraft:poisonous_potato", base_item="poisonous_potato", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='poison', duration_in_ticks=100)]), food=Food(nutrition=2, saturation=1)))
PORKCHOP = CustomItem(internal_name="minecraft:porkchop", base_item="porkchop", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=3, saturation=1)))
POTATO = CustomItem(internal_name="minecraft:potato", base_item="potato", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=1)))
POTION = CustomItem(internal_name="minecraft:potion", base_item="potion", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(animation='drink', consuming_sound='minecraft:entity.generic.drink', has_consume_particles=False), use_remainder=UseRemainder(item='minecraft:glass_bottle')), max_stack_size=1)
PUFFERFISH = CustomItem(internal_name="minecraft:pufferfish", base_item="pufferfish", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='poison', amplifier=1, duration_in_ticks=1200), PotionEffect(effect_name='hunger', amplifier=2, duration_in_ticks=300), PotionEffect(effect_name='nausea', duration_in_ticks=300)]), food=Food(nutrition=1)))
PUMPKIN_PIE = CustomItem(internal_name="minecraft:pumpkin_pie", base_item="pumpkin_pie", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=8, saturation=4)))
PURPLE_CARPET = CustomItem(internal_name="minecraft:purple_carpet", base_item="purple_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
RABBIT = CustomItem(internal_name="minecraft:rabbit", base_item="rabbit", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=3, saturation=1)))
RABBIT_STEW = CustomItem(internal_name="minecraft:rabbit_stew", base_item="rabbit_stew", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=10, saturation=12), use_remainder=UseRemainder(item='minecraft:bowl')), max_stack_size=1)
RED_CARPET = CustomItem(internal_name="minecraft:red_carpet", base_item="red_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
ROTTEN_FLESH = CustomItem(internal_name="minecraft:rotten_flesh", base_item="rotten_flesh", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='hunger', duration_in_ticks=600)]), food=Food(nutrition=4)))
SADDLE = CustomItem(internal_name="minecraft:saddle", base_item="saddle", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='saddle', equip_sound='minecraft:entity.horse.saddle', entities_which_can_wear='#minecraft:can_equip_saddle')), max_stack_size=1)
SALMON = CustomItem(internal_name="minecraft:salmon", base_item="salmon", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2)))
SHEARS = CustomItem(internal_name="minecraft:shears", base_item="shears", components=Components(durability=238, break_sound='minecraft:entity.item.break', tool=Tool(rules=[ToolRule(blocks='minecraft:cobweb', speed=15.0), ToolRule(blocks='#minecraft:leaves', speed=15.0), ToolRule(blocks='#minecraft:wool', speed=5.0), ToolRule(blocks=['minecraft:vine', 'minecraft:glow_lichen'], speed=2.0)])), max_stack_size=1)
SHIELD = CustomItem(internal_name="minecraft:shield", base_item="shield", components=Components(durability=336, repaired_by='#minecraft:wooden_tool_materials', break_sound='minecraft:item.shield.break', blocks_attacks=BlocksAttacks(block_delay_seconds=0.25, disable_cooldown_scale=1.0, damage_reductions=[], item_damage_threshold=3.0, item_damage_base=1.0, item_damage_factor=1.0, block_sound='minecraft:item.shield.block', disable_sound=None, bypassed_by='#minecraft:bypasses_shield'), equippable=Equippable(slot='offhand', swappable=False)), max_stack_size=1)
SKELETON_SKULL = CustomItem(internal_name="minecraft:skeleton_skull", base_item="skeleton_skull", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="uncommon")
SPIDER_EYE = CustomItem(internal_name="minecraft:spider_eye", base_item="spider_eye", components=Components(break_sound='minecraft:entity.item.break', consumable=Consumable(on_consume_effects=[PotionEffect(effect_name='poison', duration_in_ticks=100)]), food=Food(nutrition=2, saturation=3)))
STONE_AXE = CustomItem(internal_name="minecraft:stone_axe", base_item="stone_axe", components=Components(durability=131, enchantable_at_level=5, repaired_by='#minecraft:stone_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=8.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.2)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_stone_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/axe', speed=4.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=5.0)), max_stack_size=1)
STONE_HOE = CustomItem(internal_name="minecraft:stone_hoe", base_item="stone_hoe", components=Components(durability=131, enchantable_at_level=5, repaired_by='#minecraft:stone_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=0.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_stone_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/hoe', speed=4.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
STONE_PICKAXE = CustomItem(internal_name="minecraft:stone_pickaxe", base_item="stone_pickaxe", components=Components(durability=131, enchantable_at_level=5, repaired_by='#minecraft:stone_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=2.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.8)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_stone_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/pickaxe', speed=4.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
STONE_SHOVEL = CustomItem(internal_name="minecraft:stone_shovel", base_item="stone_shovel", components=Components(durability=131, enchantable_at_level=5, repaired_by='#minecraft:stone_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=2.5), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_stone_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/shovel', speed=4.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
...
SUSPICIOUS_STEW = CustomItem(internal_name="minecraft:suspicious_stew", base_item="suspicious_stew", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=6, saturation=7, can_always_eat=True), use_remainder=UseRemainder(item='minecraft:bowl')), max_stack_size=1)
SWEET_BERRIES = CustomItem(internal_name="minecraft:sweet_berries", base_item="sweet_berries", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=2)))
TOTEM_OF_UNDYING = CustomItem(internal_name="minecraft:totem_of_undying", base_item="totem_of_undying", components=Components(break_sound='minecraft:entity.item.break', death_protection=DeathProtection(apply_affects=[PotionEffect(effect_name='regeneration', amplifier=1, duration_in_ticks=900), PotionEffect(effect_name='absorption', amplifier=1, duration_in_ticks=100), PotionEffect(effect_name='fire_resistance', duration_in_ticks=800)], remove_effects='all')), max_stack_size=1, rarity="uncommon")
TRIDENT = CustomItem(internal_name="minecraft:trident", base_item="trident", components=Components(durability=250, enchantable_at_level=1, break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=8.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.9)], tool=Tool(damage_per_block=2)), max_stack_size=1, rarity="rare")
TROPICAL_FISH = CustomItem(internal_name="minecraft:tropical_fish", base_item="tropical_fish", components=Components(break_sound='minecraft:entity.item.break', food=Food(nutrition=1)))
TURTLE_HELMET = CustomItem(internal_name="minecraft:turtle_helmet", base_item="turtle_helmet", components=Components(durability=275, enchantable_at_level=9, repaired_by='#minecraft:repairs_turtle_helmet', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='head', amount=2.0), AttributeModifier(attribute_type='armor_toughness', slot='head', amount=0.0)], equippable=Equippable(slot='head', equip_sound='minecraft:item.armor.equip_turtle')), max_stack_size=1)
WARPED_FUNGUS_ON_A_STICK = CustomItem(internal_name="minecraft:warped_fungus_on_a_stick", base_item="warped_fungus_on_a_stick", components=Components(durability=100, break_sound='minecraft:entity.item.break'), max_stack_size=1)
WHITE_CARPET = CustomItem(internal_name="minecraft:white_carpet", base_item="white_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
WIND_CHARGE = CustomItem(internal_name="minecraft:wind_charge", base_item="wind_charge", components=Components(break_sound='minecraft:entity.item.break', cooldown=Cooldown(seconds=0.5)))
WITHER_SKELETON_SKULL = CustomItem(internal_name="minecraft:wither_skeleton_skull", base_item="wither_skeleton_skull", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="rare")
WOLF_ARMOR = CustomItem(internal_name="minecraft:wolf_armor", base_item="wolf_armor", components=Components(durability=64, repaired_by='#minecraft:repairs_wolf_armor', break_sound='minecraft:item.wolf_armor.break', attribute_modifiers=[AttributeModifier(attribute_type='armor', slot='body', amount=11.0), AttributeModifier(attribute_type='armor_toughness', slot='body', amount=0.0)], equippable=Equippable(slot='body', equip_sound='minecraft:item.armor.equip_wolf', entities_which_can_wear='minecraft:wolf')), max_stack_size=1)
WOODEN_AXE = CustomItem(internal_name="minecraft:wooden_axe", base_item="wooden_axe", components=Components(durability=59, enchantable_at_level=15, repaired_by='#minecraft:wooden_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=6.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.2)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_wooden_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/axe', speed=2.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=5.0)), max_stack_size=1)
WOODEN_HOE = CustomItem(internal_name="minecraft:wooden_hoe", base_item="wooden_hoe", components=Components(durability=59, enchantable_at_level=15, repaired_by='#minecraft:wooden_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=0.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_wooden_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/hoe', speed=2.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
WOODEN_PICKAXE = CustomItem(internal_name="minecraft:wooden_pickaxe", base_item="wooden_pickaxe", components=Components(durability=59, enchantable_at_level=15, repaired_by='#minecraft:wooden_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand'), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.8)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_wooden_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/pickaxe', speed=2.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
WOODEN_SHOVEL = CustomItem(internal_name="minecraft:wooden_shovel", base_item="wooden_shovel", components=Components(durability=59, enchantable_at_level=15, repaired_by='#minecraft:wooden_tool_materials', break_sound='minecraft:entity.item.break', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=1.5), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-3.0)], tool=Tool(rules=[ToolRule(blocks='#minecraft:incorrect_for_wooden_tool', correct_for_drops=False), ToolRule(blocks='#minecraft:mineable/shovel', speed=2.0)]), weapon=Weapon(item_damage_per_attack=2, disable_blocking_for_seconds=0)), max_stack_size=1)
...
YELLOW_CARPET = CustomItem(internal_name="minecraft:yellow_carpet", base_item="yellow_carpet", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='body', equip_sound='minecraft:entity.llama.swag', entities_which_can_wear=['minecraft:llama', 'minecraft:trader_llama'])))
ZOMBIE_HEAD = CustomItem(internal_name="minecraft:zombie_head", base_item="zombie_head", components=Components(break_sound='minecraft:entity.item.break', equippable=Equippable(slot='head', swappable=False)), rarity="uncommon")
