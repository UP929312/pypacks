...
class Raycast:
    ...
    def generate_default_raycast_functions(pack_namespace: str) -> tuple["MCFunction", ...]:
        ...
        # Each Ray iteration
        ray = MCFunction("ray", [
            "# Requires the following macros when calling: condition, on_successful_hit, on_failure",
            # "say Running the ray!",
            "",
            ...
            "$execute if score #hit raycast matches 0 if score #distance raycast matches 551.. run $(on_failure)",
            "",
    ...
    def create_datapack_files(self, pack: "Pack") -> None:
        ...
        prepare_ray_subdirectory = self._create_prepare_ray_command("", "", "", "").sub_directories[-1]
    ...
    def _create_prepare_ray_command(self, condition: str, on_successful_hit: str, on_failure: str, pack_namespace: str) -> "MCFunction":
        from pypacks.resources.custom_mcfunction import MCFunction
