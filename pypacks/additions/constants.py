...
NON_EXPERIMENTAL_FEATURES = [
    # A list of features which won't show a warning when loaded in the game
    "advancement", "function", "loot_table", "predicate", "recipe", "structure", "tag",
]
