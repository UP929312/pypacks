...
CARVED_PUMPKIN = CustomItem(internal_name="minecraft:carved_pumpkin", base_item="carved_pumpkin", components=Components(equippable=Equippable(slot='head', swappable=False)))
...
DIAMOND_SWORD = CustomItem(internal_name="minecraft:diamond_sword", base_item="diamond_sword", components=Components(durability=1561, enchantable_at_level=10, repaired_by=['#minecraft:diamond_tool_materials'], attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=6.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.4)], tool=Tool(damage_per_block=2, rules=[ToolRule(blocks='minecraft:cobweb', speed=15.0), ToolRule(blocks='#minecraft:sword_efficient', speed=1.5)])), max_stack_size=1)
...
GOLDEN_SWORD = CustomItem(internal_name="minecraft:golden_sword", base_item="golden_sword", components=Components(durability=32, enchantable_at_level=22, repaired_by=['#minecraft:gold_tool_materials'], attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=3.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.4)], tool=Tool(damage_per_block=2, rules=[ToolRule(blocks='minecraft:cobweb', speed=15.0), ToolRule(blocks='#minecraft:sword_efficient', speed=1.5)])), max_stack_size=1)
...
IRON_SWORD = CustomItem(internal_name="minecraft:iron_sword", base_item="iron_sword", components=Components(durability=250, enchantable_at_level=14, repaired_by=['#minecraft:iron_tool_materials'], attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=5.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.4)], tool=Tool(damage_per_block=2, rules=[ToolRule(blocks='minecraft:cobweb', speed=15.0), ToolRule(blocks='#minecraft:sword_efficient', speed=1.5)])), max_stack_size=1)
...
NETHERITE_SWORD = CustomItem(internal_name="minecraft:netherite_sword", base_item="netherite_sword", components=Components(durability=2031, enchantable_at_level=15, repaired_by=['#minecraft:netherite_tool_materials'], damage_resistant_to='#minecraft:is_fire', attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=7.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.4)], tool=Tool(damage_per_block=2, rules=[ToolRule(blocks='minecraft:cobweb', speed=15.0), ToolRule(blocks='#minecraft:sword_efficient', speed=1.5)])), max_stack_size=1)
...
STONE_SWORD = CustomItem(internal_name="minecraft:stone_sword", base_item="stone_sword", components=Components(durability=131, enchantable_at_level=5, repaired_by=['#minecraft:stone_tool_materials'], attribute_modifiers=[AttributeModifier(attribute_type='attack_damage', slot='mainhand', amount=4.0), AttributeModifier(attribute_type='attack_speed', slot='mainhand', amount=-2.4)], tool=Tool(damage_per_block=2, rules=[ToolRule(blocks='minecraft:cobweb', speed=15.0), ToolRule(blocks='#minecraft:sword_efficient', speed=1.5)])), max_stack_size=1)
