...
REGULAR_CALLS = re.compile(r"(?:^|\n) *function (#?[\w-]+:[\w/-]+)")  # ($)?function namespace:name/subdir
...
VARIABLE_PAIR_PATTERNS = [
    ...
    EXECUTE_STORE_ENTITY, SCOREBOARD_OPERATION,
    DATA_MODIFY_STORAGE, DATA_MODIFY_ENTITY,
]
VARIABLE_REQUIRE_OBJECTIVE_PATTERNS = [
    PLAYER_SCORE_CHANGE, BOSSBAR_SET, SCOREBOARD_GET,
]
# REQUIRE_ODD_GROUPS = [
#     SELECTOR_SCORE_PATTERN,
# ]
# ================================================================================================================== #
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
# ================================================================================================================== #
